...
public class BeaconSubjectRepositoryTests {
    ...
    @Test
    @UsingDataSet(locations = {"beacon-subject-1.json"}, loadStrategy = LoadStrategyEnum.INSERT)
    ...
    @Test
    @UsingDataSet(locations = {"beacon-subject-2.json"}, loadStrategy = LoadStrategyEnum.INSERT)

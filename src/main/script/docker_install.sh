...
sudo docker run -d -p 8080:8080 -p 9089:9089 -e "SPRING_PROFILES_ACTIVE=prod" -e "shaka.redis.host=52.88.222.82" --link shaka-mongo:mongo $(sudo docker images -f "label=com.weshaka.label=ole_svc_1.0.0" -q)